...
public class IdentificadorValidator {
	...
	public static void validarCpfCnpj(String identificador) throws IdentificadorInvalidoException {
		if (identificador == null || identificador.isEmpty()) {
			throw new IdentificadorInvalidoException("Identificador não pode ser nulo ou vazio.");
		}
		...
		if (identificador.length() == 11) {
			...
			throw new IdentificadorInvalidoException("Tamanho do identificador inválido.");
		}
	}
	...
	public static boolean validarEstudanteUniversitario(String identificador) throws IdentificadorInvalidoException{
		...
		if ((primeiroDigito + ultimoDigito) != 9) {
			throw new IdentificadorInvalidoException(
					"A soma do primeiro e do último dígito do identificador de estudante universitário deve ser igual a 9.");
		}

		return true;
	}

	public static boolean validarAposentado(String identificador) throws IdentificadorInvalidoException{
		...
		if (primeirosNoveDigitos.indexOf(ultimoDigito) != -1) {
			throw new IdentificadorInvalidoException(
					"Identificador de aposentado não deve repetir o último dígito nos primeiros nove dígitos.");
		}
